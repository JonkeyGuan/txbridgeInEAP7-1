...
public class ServiceATImpl implements ServiceAT {
	...
	public void addUser(User user) {
		...
		// System.out.println(
		// "[SERVICE] Calling addUser on the WS remoteClient stub. The
		// registered interceptor will bridge rom JTA to WS-AT");
	...
	public void addUserWithException(User user) {
		...
		// System.out.println(
		// "[SERVICE] Calling addUserWithException on the WS remoteClient stub.
